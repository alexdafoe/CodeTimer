...
Item {
    ...
    Dialog {
        ...
        onAccepted: {
            dataBase.editNote(databaseModel.getIdByRowId(tableView.currentRow),
                                    dialogEditTxtInput.getText(0, dialogEditTxtInput.length));
            databaseModel.updateWithLastQuery();
        }
        onRejected: {
            //console.log("reject");
        }
    ...
    MessageDialog {
        ...
        onAccepted: {
            dataBase.deleteRecordById(databaseModel.getIdByRowId(tableView.currentRow));
