...
Item {
    ...
    function loadNote() {
        databaseModel.сlearIdList(); // clear idList after date changed
        ...
        boxChooseNote.model = databaseModel.noteByDate(dateWithNote);
    ...
    Dialog {
        ...
        onAccepted: {
            tableViewSelection.selection.forEach( function(rowIndex) {
                databaseModel.addSelectedIdToList(databaseModel.getIdByRowId(rowIndex));
            }
            );
        }
